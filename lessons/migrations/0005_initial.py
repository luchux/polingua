...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExerciseBase'
        db.create_table('lessons_exercisebase', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('lessons', ['ExerciseBase'])

        # Adding model 'ExerciseSentence'
        db.create_table('lessons_exercisesentence', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sentence', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lessons.Sentence'])),
            ('level', self.gf('django.db.models.fields.IntegerField')(default=1, blank=True)),
            ('tries', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('corrects', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('last_correct', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('lessons', ['ExerciseSentence'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ExerciseBase'
        db.delete_table('lessons_exercisebase')

        # Deleting model 'ExerciseSentence'
        db.delete_table('lessons_exercisesentence')
    ...
    models = {
        ...
        'lessons.dialoguesentence': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sentence': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lessons.Sentence']"}),
        ...
        'lessons.exercisebase': {
            'Meta': {'object_name': 'ExerciseBase'},
            'corrects': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_correct': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'tries': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'})
        },
        'lessons.exercisesentence': {
            'Meta': {'object_name': 'ExerciseSentence'},
            'corrects': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_correct': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
