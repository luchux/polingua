...
DATABASES = {
    'default': {
        ...
        'NAME': 'db_polingua',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '6x0^a-%8-63^eyj5)%-c%goo4a@a316ost^0ivdw^5_4941@zt'
...
MIDDLEWARE_CLASSES = (
    'polingua.middlewares.crossdomain.XsSharing',
...
ROOT_URLCONF = 'polingua.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'polingua.wsgi.application'
